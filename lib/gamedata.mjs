...
export const TALENT_INFO = {
  feral_thick_hide:       { ru: 'Thick Hide (+armor)', max: 3 },
  feral_brutal_impact:    { ru: 'Brutal Impact (Maul/Swipe)', max: 2 },
  feral_feline_swiftness: { ru: 'Feline Swiftness (+dodge)', max: 2 },
  feral_choice:           { ru: 'Beast Instinct', max: 1 },
  feral_heart_wild:       { ru: 'Heart of the Wild', max: 2 },
  feral_ferocity:         { ru: 'Ferocity (cheaper Maul)', max: 3 },
  // paladin (retribution)
  ret_benediction:        { ru: 'Benediction (cheaper Seal/Judgement)', max: 3 },
  ret_seal_command:       { ru: 'Seal of Command (+seal damage)', max: 2 },
  ret_imp_judgement:      { ru: 'Improved Judgement (cooldown/damage)', max: 2 },
  ret_choice:             { ru: 'Retribution Path', max: 1 },
  ret_crusader_strikes:   { ru: 'Crusader Strikes (+damage)', max: 2 },
  ret_conviction:         { ru: 'Conviction (+critical strike)', max: 3 },
};
...
export const SPEC_RU = { feral: 'Feral (bear)', balance: 'Balance', restoration: 'Restoration', retribution: 'Retribution (DPS)', holy: 'Holy (healer)', protection: 'Protection (tank)' };
